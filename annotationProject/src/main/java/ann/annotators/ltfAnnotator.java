...
public class ltfAnnotator {
    ...
    public static void main(String[] args) {
        ...
        for (File f : files) {
            ...
            List<Sample> listOfsents = docObject.reader(f.getAbsolutePath());
            if (docObject.getDocLang().equals("eng")) {
                ...
                try (FileWriter writer = new FileWriter("../outFiles/HC0000.ltf/" + docObject.getDocId() + ".json")) {
